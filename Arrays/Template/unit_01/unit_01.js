...
//и с помощью indexOf ищет данный элемент в массиве a1.+
...
// и с помощью indexOf и ищет данный элемент в массиве a2.+
...
//Функция считывает значение из i-3 и с помощью indexOf ищет данный элемент в массиве a3.+
...
//Функция должна с помощью indexOf найти и вывести в out-4 индекс искомого элемента в массиве a4 или -1 если элемента в массиве нет.+ Протестируйте задачу на строке '2' и числе 2. Сделайте выводы.+
...
//Функция считывает значение из i-5-1 +
//и индекс с которого начинается поиск в массиве с i-5-2 +
//и с помощью indexOf ищет данный элемент в массиве a5 c позиции указанной в i-5-2.+
// Выводит в out-5 индекс если он есть в массиве, или -1 если нет.+

// Введите пары и изучите поведение
// число 33 и индекс старта 2 (7)
// число 33 и индекс старта 0 (1)
// число 44 и индекс старта 50 (-1)
// число 44 и индекс старта -3 (-1)
...
const f5 = () => {
  ...
  const out = a5.indexOf(num, start);
  document.querySelector(".out-5").textContent = out;
};

// TASK 06
// По нажатию b-6 выполняется функция f6. +
//Функция считывает значение из i-6 +
//и с помощью indexOf ищет данный элемент в СТРОКЕ a6.+
...
//Функция должна эмулировать работу метода indexOf с помощью цикла. +
//Что понимается под эмуляцией? Мы не используем метод indexOf, а циклом перебираем массив и с помощью if решаем задачу.+
...
// Индексы должны быть добавлены в res08.+
// Результат (res08) выведите в out-8.+
...
//и с помощью цикла и indexOf вывести в out-9 все индексы вложенных в a9 массивов содержащие указанное число.+
...
const f9 = () => {
  ...
  document.querySelector(".out-9").textContent = out.join(" ");
};
